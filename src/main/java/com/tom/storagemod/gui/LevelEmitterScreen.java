...
public class LevelEmitterScreen extends AbstractContainerScreen<LevelEmitterMenu> implements IDataReceiver {
	...
	private class AmountBtn {
		...
		public AmountBtn(int x, int y, int v, int sv, int len) {
			btn = new Button(LevelEmitterScreen.this.leftPos + x, LevelEmitterScreen.this.topPos + y + 16, len, 20, Component.literal((v > 0 ? "+" : "") + v), this::evt);
