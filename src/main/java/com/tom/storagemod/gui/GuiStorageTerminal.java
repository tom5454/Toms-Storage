...
public class GuiStorageTerminal extends ContainerScreen<ContainerStorageTerminal> implements IHasContainer<ContainerStorageTerminal> {
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		boolean flag = GLFW.glfwGetMouseButton(Minecraft.getInstance().func_228018_at_().getHandle(), GLFW.GLFW_MOUSE_BUTTON_LEFT) != GLFW.GLFW_RELEASE;
		int i = this.guiLeft;
		int j = this.guiTop;
		int k = i + 174;
		int l = j + 18;
	...
	public boolean mouseClicked(double mouseX, double mouseY, int mouseButton) {
		...
		} else if (GLFW.glfwGetKey(mc.func_228018_at_().getHandle(), GLFW.GLFW_KEY_SPACE) != GLFW.GLFW_RELEASE) {
	...
	public boolean keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_) {
		...
		return !this.searchField.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_) && !this.searchField.func_212955_f() ? super.keyPressed(p_keyPressed_1_, p_keyPressed_2_, p_keyPressed_3_) : true;
	}
