...
public class GuiFiltered extends HandledScreen<ContainerFiltered> {
	private static final Identifier DISPENSER_GUI_TEXTURES = new Identifier("textures/gui/container/dispenser.png");

	public GuiFiltered(ContainerFiltered container, PlayerInventory playerInventory, Text textComponent) {
