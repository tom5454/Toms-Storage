...
public class TileEntityOpenCrate extends BlockEntity implements SidedStorageBlockEntity, TickableServer {
	...
	private class Handler extends SnapshotParticipant<List<State>> implements Storage<ItemVariant> {
		...
		public long extract(ItemVariant resource, long maxAmount, TransactionContext transaction) {
			...
			for (ItemEntity e : new ArrayList<>(items)) {
				if(resource.matches(e.getStack()) && e.isAlive()) {
