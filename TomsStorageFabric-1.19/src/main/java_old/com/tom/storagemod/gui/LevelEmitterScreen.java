...
public class LevelEmitterScreen extends HandledScreen<LevelEmitterMenu> implements IDataReceiver {
	...
	public LevelEmitterScreen(LevelEmitterMenu screenContainer, PlayerInventory inv, Text titleIn) {
	...
	private class AmountBtn {
		...
		public AmountBtn(int x, int y, int v, int sv, int len) {
			btn = new ButtonWidget(LevelEmitterScreen.this.x + x, LevelEmitterScreen.this.y + y + 16, len, 20, Text.literal((v > 0 ? "+" : "") + v), this::evt);
